 ...
 */
@WebServlet(name = "/PerformTitleSearch", urlPatterns={"/demo", "/validated"})
...
//		InputStream fileContent = filePart.getInputStream();
		...
		BufferedInputStream fileContent = new BufferedInputStream(new FileInputStream(file));
